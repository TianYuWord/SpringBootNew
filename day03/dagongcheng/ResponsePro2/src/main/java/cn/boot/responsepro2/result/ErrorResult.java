package cn.boot.responsepro2.result;
...
public class ErrorResult {
     ...
     * 对异常提示语进行封装
     */
    public static cn.boot.responsepro2.result.ErrorResult fail(ResultCode resultCode, Throwable e, String message){
        cn.boot.responsepro2.result.ErrorResult errorResult = fail(resultCode,e);
